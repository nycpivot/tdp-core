(() => {
  ...
  var G = (t, e, r) =>
    ...
    X = (t, e) => {
      ...
      if (Y) for (var r of Y(e)) ve.call(e, r) && G(t, r, e[r]);
      return t;
    };
  var xe = t => B(t, '__esModule', { value: !0 });
...
`,
          ...
          D = function (l) {
            ...
            if (((f = T), f.test(l))) {
              ...
              (m = S[1]),
                ...
                (x = b),
                (R = V),
                (f.test(m) || (x.test(m) && !R.test(m))) && (l = m);
            }
            return (
              (f = $),
              (x = g),
                ...
                if (g == h || h == '*') {
                  ...
                  g in n.output.edges
                    ...
                    : ((p = new t.TokenSet()),
                      (p.final = Q),
                      (n.output.edges[g] = p)),
                    i.push({ qNode: v, output: p, node: b });
                }
              }
          }
          return r;
            ...
            for (var g = 0; g < h.length; g++) {
              ...
              for (var w = 0; w < Q.length; w++)
                for (
                  ...
                  if (
                    (i[d].upsert(I, c.boost, function (fe, pe) {
                      return fe + pe;
                    }),
                    !s[j])
                  ) {
            ...
            for (var b = 0; b < h.length; b++) {
              ...
              for (var d = 0; d < this.metadataWhitelist.length; d++) {
                var w = this.metadataWhitelist[d],
                  L = v.metadata[w];
                this.invertedIndex[v][o][n][w] == null &&
                  (this.invertedIndex[v][o][n][w] = []),
                  this.invertedIndex[v][o][n][w].push(L);
              }
            }
          }
        }),
  ...
  function ue(t, e) {
    ...
    for (let s of r)
      ((i = lunr.stopWordFilter) == null ? void 0 : i.call(lunr, s.term)) &&
        (n[s.term] = !1);
    return n;
  }
  function Le(t, e) {
              ...
              .reduce((o, { ref: a, score: u, matchData: c }) => {
                ...
                if (typeof h != 'undefined') {
                  let { location: y, title: g, text: b, parent: v } = h,
                    Q = ue(n, Object.keys(c.metadata)),
                    p = +!v + +Object.values(Q).every(d => d);
                  o.push({
                    location: y,
                    title: r(g),
                    text: r(b),
  ...
  function Ee(t) {
    return z(this, null, function* () {
      switch (t.type) {
        case 0:
          return yield we(t.data.config), (q = new H(t.data)), { type: 1 };
        case 2:
          return { type: 3, data: q ? q.search(t.data) : { items: [] } };
        default:
