...
describe('Snyk v2.0.0 in TPB v1.6.0', () => {
    ...
    it('displays the Snyk Overview card on the Entity overview', () => {
        ...
        cy.intercept('GET', 'api/proxy/snyk/rest/orgs/883c2d65-1170-40d8-bf5c-bbba4a13eec1/projects*', {
            fixture: '../fixtures/snyk/projects.json'
        }).as('getProjects')

        cy.intercept('GET', 'api/proxy/snyk/rest/orgs/883c2d65-1170-40d8-bf5c-bbba4a13eec1/issues*', {
    ...
    it('displays Scan data on the Security tab', () => {
        ...
        cy.intercept('GET', 'api/proxy/snyk/v1/org/883c2d65-1170-40d8-bf5c-bbba4a13eec1/project/34258b5b-8f96-4437-9a7b-bdd20efee447/dep-graph', {
            fixture: '../fixtures/snyk/dep-graph.json'
        }).as('getDepGraph')

        cy.intercept('GET', 'api/proxy/snyk/v1/org/883c2d65-1170-40d8-bf5c-bbba4a13eec1/project/34258b5b-8f96-4437-9a7b-bdd20efee447', {
        ...
        cy.contains('Regular Expression Denial of Service (ReDoS)').should('be.visible')
